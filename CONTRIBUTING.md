Contributing to NodesReward Core
============================

The NodesReward Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nodesreward/NRCblob/master/doc/translation_process.md)
...
The following applies to code changes to the NodesReward Core project, and is not to be
confused with overall NodesReward Network Protocol consensus changes.

Whether a pull request is merged into NodesReward Core rests with the project merge
...
Patches that change NodesReward consensus rules are considerably more involved than
...
Where a patchset proposes to change the NodesReward consensus, it must have been
...
The project leader is the release manager for each NodesReward Core release.
