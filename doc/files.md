...
nrc.conf           | contains configuration settings for nrcd or nrc-qt
nrcd.pid           | stores the process id of nrcd while running
...
debug.log           | contains debug information and general logging generated by nrcd or nrc-qt
