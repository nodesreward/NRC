...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nrc.conf'
CONFIGFOLDER='/root/.nrc'
COIN_DAEMON='nrcd'
COIN_CLI='nrc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/NodesReward/NodesReward/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
