...
#define MyAppName "NodesReward"
#define MyAppPublisher "2022 NodesReward developers"
#define MyAppURL "https://nodesreward.com/"
#define MyAppExeName "nrc-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/NRC/bootstrap.zip"
...
DefaultDirName={autopf}\NodesReward
...
OutputDir=.\output
OutputBaseFilename=NodesRewardSetup
...
DefaultGroupName=NodesReward Core
...
[Files]
Source: ".\package\nrc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\NodesReward\NodesReward-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\NodesReward\NodesReward-Qt,strDataDir|{userappdata}\NodesReward\}');
  Result := True;
end;
