...
{
    const char* pszTimestamp = "Nodes Reward Coin";
    const CScript genesisOutputScript = CScript() << ParseHex("04ec50efb29c2d8afc298debab1f3d2a17526cd7ec95fbcce382e009f3a1f819c40dc5a32f1415ffa9a65fd25c24b9433db35d3baf5aaf3a33c7fe39afe3e2499f") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1700117732, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1700117732;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1700117732, 649376, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000285c0f0d76d5cf70166557f208672591734135eb44d825d72a90564f63b"));
        assert(genesis.hashMerkleRoot == uint256S("0xf384d067836aa6ead8f3fa586f4d0a31af26721c7ae42c264e0789b1ec1187fb"));
        ...
        consensus.nMaxMoneyOut = 13938851 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "04e7553bbd3d4c0e6addbc8c9fcb42945be1d548e1f1198db07da69c97a4c986538ef0a5e3e34762fc4dedf9262aa7cbda7da50c7c0f742b0e1507b3a82ad558b2";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "NKyMS8CFV6uQdV172dy7gzdHDUAqrE8Ctd";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.nodesreward.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.nodesreward.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.nodesreward.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.nodesreward.com"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.nodesreward.com"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.nodesreward.com"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.nodesreward.com"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.nodesreward.com"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xD2)(0x8F)(0x26)(0xC4).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xD2)(0x8F)(0x71)(0xAF).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x57)(0xB9).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // nrc starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet nrc addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet nrc script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nrc BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nrc BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nrc BIP44 coin type is '1' (All coin's testnet default)
