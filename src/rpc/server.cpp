...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NRC features */
        {"nrc", "listmasternodes", &listmasternodes, true },
        {"nrc", "getmasternodecount", &getmasternodecount, true },
        {"nrc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"nrc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"nrc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"nrc", "masternodecurrent", &masternodecurrent, true },
        {"nrc", "startmasternode", &startmasternode, true },
        {"nrc", "createmasternodekey", &createmasternodekey, true },
        {"nrc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"nrc", "listmasternodeconf", &listmasternodeconf, true },
        {"nrc", "getmasternodestatus", &getmasternodestatus, true },
        {"nrc", "getmasternodewinners", &getmasternodewinners, true },
        {"nrc", "getmasternodescores", &getmasternodescores, true },
        {"nrc", "preparebudget", &preparebudget, true },
        {"nrc", "submitbudget", &submitbudget, true },
        {"nrc", "mnbudgetvote", &mnbudgetvote, true },
        {"nrc", "getbudgetvotes", &getbudgetvotes, true },
        {"nrc", "getnextsuperblock", &getnextsuperblock, true },
        {"nrc", "getbudgetprojection", &getbudgetprojection, true },
        {"nrc", "getbudgetinfo", &getbudgetinfo, true },
        {"nrc", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"nrc", "mnfinalbudget", &mnfinalbudget, true },
        {"nrc", "checkbudgets", &checkbudgets, true },
        {"nrc", "mnsync", &mnsync, true },
        {"nrc", "spork", &spork, true },
        {"nrc", "getcollateral", &getcollateral, true},
...
{
    return "> nrc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49331/\n";
}
