...
/** Utility functions used by the NodesReward Qt UI.
 */
namespace GUIUtil
{
...
// Render NRC addresses in monospace font
...
// Parse "nrc:" URI into recipient object, return true on successful parsing
