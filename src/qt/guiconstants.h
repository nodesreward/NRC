...
/* NodesReward GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NodesReward"
#define QAPP_ORG_DOMAIN "nodesreward.com"
#define QAPP_APP_NAME_DEFAULT "NodesReward-Qt"
#define QAPP_APP_NAME_TESTNET "NodesReward-Qt-testnet"
