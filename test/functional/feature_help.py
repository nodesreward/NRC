...
"""Verify that starting nrc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nrc with -? for help text")
        ...
        self.log.info("Start nrc with -version for version information")
